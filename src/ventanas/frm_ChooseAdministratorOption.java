 ...
 * @author Frank
 */
public class frm_ChooseAdministratorOption extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseAdministratorOption
     */
    public frm_ChooseAdministratorOption() {
        initComponents();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_SearchAdministrator sw =new frm_SearchAdministrator();
            sw.setVisible(true);
        }else if (cmb==3) {
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ChooseAdministratorOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ChooseAdministratorOption().setVisible(true);
            }
        });
    }
