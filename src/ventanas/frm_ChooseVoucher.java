 ...
 * @author Frank
 */
public class frm_ChooseVoucher extends javax.swing.JFrame {

    
    /**
     * Creates new form frm_ChooseVoucher
     */
    public frm_ChooseVoucher() {
        initComponents();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_SearchTicket t =new frm_SearchTicket();
            t.setVisible(true);
        }else if (cmb==3) {
            frm_SearchBill b =new frm_SearchBill();
            b.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ChooseVoucher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ChooseVoucher().setVisible(true);
            }
        });
    }
