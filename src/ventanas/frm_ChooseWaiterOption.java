 ...
 * @author Frank
 */
public class frm_ChooseWaiterOption extends javax.swing.JFrame {

    /**
     * Creates new form frm_ChooseCustomersOption
     */
    public frm_ChooseWaiterOption() {
        initComponents();
    ...
    private void cmbMeseroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMeseroActionPerformed
        ...
        if (cmb==2) {
            frm_SearchWaiter sw =new frm_SearchWaiter();
            sw.setVisible(true);
        }else if (cmb==3) {
             try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ChooseWaiterOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ChooseWaiterOption().setVisible(true);
            }
        });
    }
