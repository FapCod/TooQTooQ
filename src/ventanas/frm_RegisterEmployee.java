 ...
 * @author Frank
 */
public class frm_RegisterEmployee extends javax.swing.JFrame {

    public frm_RegisterEmployee() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_RegisterEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
