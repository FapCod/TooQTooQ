...
import static ventanas.frm_SearchCustomers.user_update;

/**
 *
 * @author Frank
 */
public class frm_SearchAdministrator extends javax.swing.JFrame {
    public static String user_update = "";
    /**
     * Creates new form frm_SearchAdministrator
     */
    public frm_SearchAdministrator() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_SearchAdministrator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_SearchAdministrator().setVisible(true);
            }
        });
    }
