...
import static ventanas.frm_SearchAdministrator.user_update;

/**
 *
 * @author Frank
 */
public class frm_SearchWaiter extends javax.swing.JFrame {
    
  public static String user_update = "";
    /**
     * Creates new form frm_SearchWaiter
     */
    public frm_SearchWaiter() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_SearchWaiter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_SearchWaiter().setVisible(true);
            }
        });
    }
